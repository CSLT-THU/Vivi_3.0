...
from models.Seq2seq_12 import RNN
...
class Seq2seq_12(nn.Module):
    def __init__(self, model_param):
        super(Seq2seq_12, self).__init__()
    ...
    def forward(self, batch_size, data, criterion,
        ...
        for i in range(sen_num):
            for j in range(sen_len): # 算上'/'
                ...
                if train_soft: 
                    decoder_output = self.regularization(i, j, decoded_words[:, 1:], decoder_output, template, w1, w2)
