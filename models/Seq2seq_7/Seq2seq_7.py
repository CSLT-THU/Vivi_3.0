...
from models.Seq2seq_7 import RNN
...
class Seq2seq_7(nn.Module):
    def __init__(self, model_param):
        super(Seq2seq_7, self).__init__()
    ...
    def forward(self, batch_size, data, criterion,
        ...
        # encoder
        # (encoder_hidden, encoder_c) = self.encoder.initHidden(batch_size)  #
        encoder_hidden = self.encoder.initHidden(batch_size)  #
        encoder_outputs, encoder_hidden = self.encoder(input_batch, input_lengths, encoder_hidden) # 去掉了encoder_hidden，在ONLSTM中初始化了
