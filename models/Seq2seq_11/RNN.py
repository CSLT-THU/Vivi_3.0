...
class Regularization(nn.Module):
    def __init__(self, train_pattern): # TODO: pattern
        ...
        yun_pattern = [[0., 0., 0., 0.]] * 4
        self.yun_pattern = nn.Parameter(torch.tensor(yun_pattern, device=device, requires_grad=train_pattern))
    ...
    def forward(self, i, j, decoded_words, decoder_output, batch_size):
        ...
        if j == 6 and 0 < i < 4:  # 1-4句话最后一个字
            ...
            decoder_output = decoder_output + self.w2 * feature2
