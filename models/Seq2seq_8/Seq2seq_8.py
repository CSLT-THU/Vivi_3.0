...
from models.Seq2seq_8 import RNN
...
class Seq2seq_8(nn.Module):
    def __init__(self, model_param):
        super(Seq2seq_8, self).__init__()
        # self attn param
        ...
        self.decoder = RNN.AttnDecoderRNN(emb_size, vocab_size, hidden_size, vocab_size, n_head, 
